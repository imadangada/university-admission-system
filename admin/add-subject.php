...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  subjects(subject) value('$subject')");
    if ($query) {
...
<form name="course" method="post" >        
 ...
 <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
  ...
  <input class="form-control white_bg" id="coursename" type="text" name="subject" required>
                          </div>
                        </fieldset>
                      </div>
                    </div>
